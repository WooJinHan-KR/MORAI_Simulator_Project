...
(cl:defmethod cl:initialize-instance :after ((m <student>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'student)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<student> is deprecated: use beginner_tutorials-msg:student instead.")))
