// Generated by gencpp from file interface/AddTwoIntsResponse.msg
// DO NOT EDIT!
...
bool operator==(const ::interface::AddTwoIntsResponse_<ContainerAllocator1> & lhs, const ::interface::AddTwoIntsResponse_<ContainerAllocator2> & rhs)
{
