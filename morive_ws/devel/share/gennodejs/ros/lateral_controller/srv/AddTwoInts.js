...
// (in-package lateral_controller.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'lateral_controller/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'lateral_controller/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'lateral_controller/AddTwoInts'; }
};
