...
(cl:defmethod cl:initialize-instance :after ((m <student>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'student)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name map_loader-msg:<student> is deprecated: use map_loader-msg:student instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_loader-msg:first_name-val is deprecated.  Use map_loader-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_loader-msg:last_name-val is deprecated.  Use map_loader-msg:last_name instead.")
  (last_name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_loader-msg:age-val is deprecated.  Use map_loader-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader map_loader-msg:score-val is deprecated.  Use map_loader-msg:score instead.")
  (score m))
