...
(cl:in-package longitudinal_controller-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <student>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'student)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name longitudinal_controller-msg:<student> is deprecated: use longitudinal_controller-msg:student instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader longitudinal_controller-msg:first_name-val is deprecated.  Use longitudinal_controller-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader longitudinal_controller-msg:last_name-val is deprecated.  Use longitudinal_controller-msg:last_name instead.")
  (last_name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader longitudinal_controller-msg:age-val is deprecated.  Use longitudinal_controller-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader longitudinal_controller-msg:score-val is deprecated.  Use longitudinal_controller-msg:score instead.")
  (score m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<student>)))
  ...
  "longitudinal_controller/student")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'student)))
  "Returns string type for a message object of type 'student"
  "longitudinal_controller/student")
